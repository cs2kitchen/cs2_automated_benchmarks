...
#by default number of trials = 10, make sure you change the load time if your pc is slower
...
COMMAND = "map_workshop 3240880604 de_dust2_benchmark"
LOOPS = 10   # benchmark loops (with F4 bound to capframeX and seconds to 107)
